...
#include <QMessageBox>
#include "ui_cruisesearch.h"
#include "cruise.h"
#include "availablecruise.h"
cruiseSearch::cruiseSearch(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::cruiseSearch)
{
    ui->setupUi(this);
...
bool cruiseSearch::createDB(QString dbname)
{
...
/*
void cruiseSearch::on_comboBox_currentIndexChanged(const QString &arg1)
{
...
void cruiseSearch::on_pushButton_clicked()
{
...
*/
void cruiseSearch::searchCity(QString s)
{
...
void cruiseSearch::searchHotel(QString s)
{
   QString hotel = "name LIKE '%" + s + "%'";
   model->setFilter(hotel);
}

void cruiseSearch::searchPriceRange(double s, double t)
{
...
void cruiseSearch::searchStarRating(double s)
{
...
void cruiseSearch::ViewDetails()
{
    vector<availableCruise*> trips;
...
Reservation *reservation= new Reservation(trips);
this->close();
reservation->exec();
...
void cruiseSearch::on_pushButton_2_clicked()
{
